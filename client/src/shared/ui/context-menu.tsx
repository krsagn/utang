...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(
        "data-[variant=destructive]:text-destructive relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm opacity-50 outline-hidden transition-[opacity,scale] duration-300 select-none hover:scale-98 hover:opacity-100 focus:scale-98 focus:opacity-100 data-disabled:pointer-events-none data-disabled:opacity-30 data-inset:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
